...
import { MovementForm, type MovementFormLabels, type MovementFormOption } from "../movement-form";
...
export default async function NewMovementPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        <h1 className="text-2xl font-semibold">{t.movements.newMovementHeading}</h1>
        <p className="text-muted-foreground">{t.movements.newMovementSubtitle}</p>
      </div>
