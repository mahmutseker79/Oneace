  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <p className="text-xs text-muted-foreground">
        Invitations expire after 14 days. Teammates without an account will be prompted to create
        one. You can revoke pending invitations at any time from the table below.
      </p>
