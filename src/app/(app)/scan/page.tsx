		...
		<div className="space-y-6">
          ...
          less accurate). We surface this proactively so users know what to expect. */}
			<div className="rounded-md border border-border/60 bg-muted/30 px-4 py-3 text-xs text-muted-foreground">
				<strong className="text-foreground">Best with Chrome or Edge.</strong>{" "}
				Barcode scanning uses the native BarcodeDetector API in Chrome and Edge
				for fastest results. Firefox and Safari are supported via a software
				fallback — slightly slower but functional. No special hardware required:
				your phone or laptop camera works.
			</div>
