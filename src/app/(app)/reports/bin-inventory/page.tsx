				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
					<div>
						<h1 className="text-2xl font-semibold">
							{t.reports.binInventory.heading}
						</h1>
						<p className="text-sm text-muted-foreground">
							{t.reports.binInventory.subtitle}
						</p>
					</div>
					{canExport && warehouses.length > 0 ? (
						<ExportButton href="/reports/bin-inventory/export">
							Export CSV
						</ExportButton>
					) : null}
				</div>
					...
					<div className="grid grid-cols-3 gap-3">
						<Card>
							<CardHeader className="pb-1 pt-4">
								<CardDescription>
									{t.reports.binInventory.totalBins}
								</CardDescription>
						...
						<Card>
							<CardHeader className="pb-1 pt-4">
								<CardDescription>
									{t.reports.binInventory.totalItems}
								</CardDescription>
								<CardTitle className="text-2xl tabular-nums">
						...
						<Card>
							<CardHeader className="pb-1 pt-4">
								<CardDescription>
									{t.reports.binInventory.totalUnits}
								</CardDescription>
								<CardTitle className="text-2xl tabular-nums">
						...
						<div key={wh.warehouseId} className="space-y-3">
							<div className="flex items-baseline gap-2">
								...
								<span className="text-xs text-muted-foreground">
									·{" "}
									{t.reports.binInventory.locationSubtitle.replace(
										"{bins}",
										String(wh.totalBins),
									)}
								</span>
									...
									<CardContent className="p-0">
										<Table>
											<TableHeader>
												<TableRow>
													<TableHead>
														{t.reports.binInventory.columnItem}
													</TableHead>
