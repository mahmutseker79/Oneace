...
/**
 * Scan Activity client component (P9.3e).
 *
 * Extracted from `page.tsx` so the page can be a Server Component and
 * run a `requireActiveMembership()` guard before rendering — see
 * audit v1.0 §5.11 / P1-6. The data here is local to the browser
 * (Dexie / localStorage), so the guard is purely about not letting
 * users without an active org membership land on the page UI.
 */
...
export function ScanActivityClient() {
