...
export default async function MovementHistoryReportPage({
	...
	const visibleMovements = truncated
		? movements.slice(0, PAGE_SIZE)
		: movements;
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
					<div>
						<h1 className="text-2xl font-semibold">
							{t.reports.movementHistory.heading}
						</h1>
						<p className="text-sm text-muted-foreground">
							{t.reports.movementHistory.subtitle}
						</p>
					</div>
					...
					{filterActive ? (
						<Button asChild variant="ghost" size="sm">
							<Link href="/reports/movements">
								{t.reports.movementHistory.filterClear}
							</Link>
						</Button>
					) : null}
				</div>
					...
					<Card>
						<CardHeader>
							<CardTitle className="text-base">
								{t.reports.movementHistory.summaryByType}
							</CardTitle>
						</CardHeader>
						<CardContent className="p-0">
							<Table>
								<TableHeader>
									<TableRow>
										<TableHead>
											{t.reports.movementHistory.summaryTypeCol}
										</TableHead>
						...
						<CardContent className="p-0">
							<Table>
								<TableHeader>
									<TableRow>
										<TableHead>
											{t.reports.movementHistory.columnDate}
										</TableHead>
										<TableHead>
											{t.reports.movementHistory.columnType}
										</TableHead>
										<TableHead>
											{t.reports.movementHistory.columnItem}
										</TableHead>
