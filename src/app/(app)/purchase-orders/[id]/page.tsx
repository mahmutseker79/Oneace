		...
		<div className="space-y-6">
				...
				<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
					<div className="space-y-1">
						...
						{po.createdBy ? (
							<p className="text-xs text-muted-foreground">
								{t.purchaseOrders.detail.metaCreatedBy}:{" "}
					...
					<div className="flex items-center gap-2">
						{canMarkSent ? (
							<MarkSentButton
								id={po.id}
								label={t.purchaseOrders.detail.sendAction}
							/>
						) : null}
						{canEdit ? (
			...
			<div className="grid gap-4 md:grid-cols-3">
				...
				<Card>
					...
					<CardContent className="text-sm">
						{po.warehouse.name}{" "}
						<span className="text-muted-foreground">· {po.warehouse.code}</span>
					</CardContent>
				</Card>
			</div>
						...
						<Table className="min-w-[640px]">
							<TableHeader>
								<TableRow>
									...
									<TableHead className="text-right">
										{t.purchaseOrders.detail.columnOpen}
									</TableHead>
									<TableHead className="text-right">
				...
				<CardContent>
					{receiptEvents.size === 0 ? (
						<p className="text-sm text-muted-foreground">
							{t.purchaseOrders.detail.receiptsEmpty}
						</p>
					) : (
			...
			<Card>
				...
				<CardContent>
					{scopedAudit.length === 0 ? (
						<p className="text-sm text-muted-foreground">
							{t.purchaseOrders.detail.auditEmpty}
						</p>
					) : (
									...
									>
										<div className="flex flex-wrap items-center justify-between gap-2">
											...
											<span className="text-xs text-muted-foreground">
												{fmtDateTime(row.createdAt, region.numberLocale)} ·{" "}
												{actorLabel}
											</span>
										</div>
