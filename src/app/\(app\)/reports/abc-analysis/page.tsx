		...
		<div className="space-y-6">
							...
							<TableBody>
								{data.map((item) => (
									<TableRow key={item.itemId}>
										...
										<TableCell className="text-right font-mono text-sm">
											{region &&
												formatCurrency(item.costPrice, { currency: region.currency })}
										</TableCell>
										<TableCell className="text-right font-mono text-sm">
											{region &&
												formatCurrency(item.totalValue, { currency: region.currency })}
										</TableCell>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Recommended count schedules based on ABC classification
					</CardDescription>
				</CardHeader>
				<CardContent>
