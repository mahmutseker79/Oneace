...
function planCta(id: "free" | "pro" | "business", interval: Interval): string {
  ...
  if (interval === "year") return "Start annual trial";
    ...
    <div className="flex items-center justify-center gap-3">
      <button
        ...
        className={`text-sm font-medium transition-colors ${
          interval === "month" ? "text-foreground" : "text-muted-foreground hover:text-foreground"
        }`}
      >
        Monthly
      </button>
      ...
      <button
        ...
        className={`flex items-center gap-1.5 text-sm font-medium transition-colors ${
          interval === "year" ? "text-foreground" : "text-muted-foreground hover:text-foreground"
        }`}
      >
        Annual
