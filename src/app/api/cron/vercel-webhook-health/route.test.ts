// REMOVED — replaced by src/app/api/cron/platform-webhook-health/route.test.ts
...
describe("vercel-webhook-health (removed — see platform-webhook-health)", () => {
  it.skip("replaced by platform-webhook-health", () => {});
});
