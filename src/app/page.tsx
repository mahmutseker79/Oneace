        ...
        <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-b from-accent/40 to-background px-4 py-20 sm:px-6 sm:py-32">
          <div className="mx-auto max-w-4xl space-y-8 text-center">
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              ...
              <Button size="lg" variant="outline" asChild className="w-full sm:w-auto font-medium">
                ...
                <div className="flex-1 overflow-hidden p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">847 items · 3 locations</div>
                    </div>
                  ...
                  <div className="overflow-hidden rounded border text-xs">
                    ...
                    {[
                      ...
                      >
                        <span className="font-mono text-muted-foreground">{row.sku}</span>
        ...
        <section className="border-b border-border/60 bg-muted/20 px-4 py-16 sm:px-6">
          <div className="mx-auto max-w-4xl space-y-10">
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground">
                Whether you run a warehouse team or a single-person operation, OneAce fits your
                workflow.
              </p>
            </div>
