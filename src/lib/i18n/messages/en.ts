...
export const en = {
  ...
  pallets: {
    metaTitle: "Pallet Labels",
    heading: "Pallet Labels",
    subtitle: "Manage and print pallet barcodes for inventory tracking",
    newPallet: "Create Pallet Label",
    newPalletHeading: "Create Pallet Label",
    newPalletSubtitle: "Create a new pallet barcode label for tracking inventory pallets",
    emptyTitle: "No pallet labels yet",
    emptyBody: "Create your first pallet label to start tracking pallets by barcode.",
    emptyCta: "Create Pallet Label",
    ...
    columnActions: "Actions",
    fields: {
      itemIds: "Item SKUs or IDs",
      itemIdsHelp: "Enter one or more item IDs/SKUs (one per line). At least one item is required.",
      warehouseId: "Warehouse",
      binId: "Bin",
      binIdHelp: "Optional bin code or ID",
      quantity: "Quantity",
      quantityHelp: "Total number of items on this pallet",
      barcodeValue: "Barcode Value",
      barcodeValueHelp: "Leave blank to generate a unique barcode automatically",
      notes: "Notes",
      notesHelp: "Additional notes about this pallet",
    },
    errors: {
      createFailed: "Could not create pallet label.",
      updateFailed: "Could not update pallet label.",
      deleteFailed: "Could not delete pallet label.",
      notFound: "Pallet label not found.",
      warehouseNotFound: "Warehouse not found.",
      itemsNotFound: "One or more items not found.",
      binNotFound: "Bin not found in selected warehouse.",
      barcodeExists: "Barcode value already exists.",
    },
    deleteConfirmTitle: "Delete this pallet label?",
    deleteConfirmBody: "This cannot be undone.",
    created: "Pallet label created.",
    updated: "Pallet label updated.",
    deleted: "Pallet label deleted.",
    printed: "Pallet label printed.",
  },
  ...
  reports: {
    ...
    abcAnalysis: {
      metaTitle: "ABC Analysis",
      heading: "ABC Analysis",
      description: "Pareto analysis of your inventory value distribution",
      subtitle: "Pareto analysis of your inventory",
      backToReports: "Back to reports",
      upgradeReason: "ABC analysis is available on Pro and Business plans.",
      upgradeDescription: "Upgrade to access ABC classification and Pareto analysis.",
      kpiTotalItems: "Total Items",
      kpiTotalValue: "Total Value",
      kpiClassAItems: "Class A Items",
      ...
      distributionDescription: "Items and value by ABC class",
      tableTitle: "ABC Items",
      tableDescription: "All items with classifications",
      columnSku: "SKU",
      columnName: "Name",
      columnQty: "Qty",
      columnCost: "Cost",
      columnValue: "Value",
      columnPercent: "% of Total",
      columnCumulative: "Cumulative %",
      columnClass: "Class",
      ...
      classCRecommendation: "Count annually or as-needed; lower priority for accuracy",
      exportCsv: "CSV",
      exportXlsx: "XLSX",
      exportPdf: "PDF",
      errorTitle: "Error",
      ...
      exportedFilename: "abc-analysis",
    },
    countComparison: {
      metaTitle: "Count Comparison",
      heading: "Count Comparison",
      description: "Compare results between two stock counts to identify discrepancies",
      backToReports: "Back to reports",
      upgradeReason: "Count comparison is available on Pro and Business plans.",
      upgradeDescription: "Upgrade to access count comparison tools.",
      selectLabel: "Select count",
      compareButton: "Compare",
      comparing: "Comparing...",
      noCountsSelected: "Please select two counts to compare",
      comparisonTitle: "Comparison Results",
      comparisonDescription: "Variance analysis between selected counts",
      columnSku: "SKU",
      columnName: "Name",
      columnCount1: "Count 1",
      columnCount2: "Count 2",
      columnVariance: "Variance",
      columnVariancePercent: "Variance %",
      exportCsv: "CSV",
      exportXlsx: "XLSX",
      errorTitle: "Error",
      comparisonFailed: "Comparison failed",
      exportFailed: "Export failed",
      exportedFilename: "count-comparison",
    },
    varianceTrend: {
      metaTitle: "Variance Trend",
      heading: "Variance Trend",
      description: "Track inventory variance trends over time",
      backToReports: "Back to reports",
      chartTitle: "Variance Over Time",
      chartDescription: "Stock count variances by period",
      kpiAverageVariance: "Average Variance",
      kpiTotalCounts: "Total Counts",
    ...
    departmentVariance: {
      metaTitle: "Department Variance",
      heading: "Department Variance",
      description: "Variance analysis by department or location",
      backToReports: "Back to reports",
      chartTitle: "Variance by Department",
      chartDescription: "Stock count variances by department",
      kpiHighestVariance: "Highest Variance",
      kpiLowestVariance: "Lowest Variance",
      kpiAverageVariance: "Average Variance",
  ...
  audit: {
    ...
    actions: {
      ...
      // Count zones
      "count_zone.created": "Created count zone",
      "count_zone.updated": "Updated count zone",
      "count_zone.deleted": "Deleted count zone",
      "count_zone.barcodes_generated": "Generated zone barcodes",
      "vehicle.created": "Created vehicle",
      "vehicle.updated": "Updated vehicle",
      "vehicle.deleted": "Deleted vehicle",
      "vehicle.loaded": "Loaded shipment to vehicle",
      "vehicle.unloaded": "Unloaded shipment from vehicle",
      "migration.created": "Created data migration",
      ...
      "migration.cancelled": "Cancelled data migration",
      "migration.deleted": "Deleted data migration",
      "migration.rollback": "Rolled back data migration",
      "migration.rollback_complete": "Completed migration rollback",
      "migration.mapping_saved": "Saved migration field mapping",
      "migration.files_uploaded": "Uploaded migration source files",
      "migration.detection_complete": "Completed migration file detection",
      "migration.validation_complete": "Completed migration validation",
  ...
  countZones: {
    ...
    columnColor: "Color",
    columnBarcode: "Barcode",
    columnBarcodeStatus: "Status",
    columnEntries: "Entries",
    columnAction: "Actions",
    barcodeStatusGenerated: "Generated",
    barcodeStatusMissing: "No barcode",
    barcodeStatusNotGenerated: "Not set",
    formHeading: "Zone details",
    formNameLabel: "Zone name",
    formNamePlaceholder: "e.g. Front aisle A, Warehouse 2 shelves 5-8",
    formDescriptionLabel: "Description",
    formDescriptionPlaceholder: "Optional notes about this zone",
    formColorLabel: "Color indicator",
    formBarcodeLabel: "Barcode value",
    formBarcodePlaceholder: "Leave blank to auto-generate",
    formBarcodeFormatLabel: "Barcode format",
    formParentZoneLabel: "Parent zone",
    formParentZonePlaceholder: "Optional — create sub-zones",
    formPromoteToBinLabel: "Promote to bin on completion",
    formPromoteToBinHelp: "Automatically create a bin when this zone count is completed",
    formCreateButton: "Create zone",
    formUpdateButton: "Update zone",
    formCancelButton: "Cancel",
    createSuccess: "Zone created successfully",
    updateSuccess: "Zone updated successfully",
    deleteConfirm: "Delete this zone? This action cannot be undone.",
    deleteSuccess: "Zone deleted successfully",
    errors: {
      createFailed: "Could not create this zone.",
      updateFailed: "Could not update this zone.",
      deleteFailed: "Could not delete this zone.",
      deleteHasEntries: "Cannot delete a zone with count entries. Remove the entries first.",
      notFound: "Zone not found.",
      zoneNotBelongsToCount: "This zone does not belong to this stock count.",
  ...
  vehicles: {
    metaTitle: "Vehicles",
    heading: "Vehicles",
    subtitle: "Manage your delivery vehicles and fleet",
    newVehicle: "New vehicle",
    newVehicleHeading: "Create a new vehicle",
    newVehicleSubtitle: "Add a vehicle to track in your fleet",
    editVehicle: "Edit vehicle",
    detailMetaTitle: "Vehicle details",
    emptyTitle: "No vehicles yet",
    emptyBody: "Create your first vehicle to track deliveries and shipments.",
    emptyCta: "Create your first vehicle",
    columnName: "Name",
    columnLicensePlate: "License plate",
    columnStatus: "Status",
    columnLastActivity: "Last activity",
    columnCreated: "Created",
    columnDescription: "Description",
    backToList: "Back to vehicles",
    loadingHeading: "Manage loads",
    loadingDescription: "Track shipments assigned to this vehicle",
    historyHeading: "Activity log",
    historyEmpty: "No activity yet",
    assignShipment: "Assign shipment",
    assignShipmentTitle: "Assign shipment",
    assignShipmentDescription: "Add a sales order or shipment to this vehicle",
    salesOrderIdHelp: "Optional: link a specific sales order",
    assignButton: "Assign",
    errors: {
      createFailed: "Could not create vehicle.",
      updateFailed: "Could not update vehicle.",
      deleteFailed: "Could not delete vehicle.",
      notFound: "Vehicle not found.",
      hasActiveLoads: "Vehicle has active loads and cannot be deleted.",
      loadFailed: "Could not load shipment.",
      unloadFailed: "Could not unload shipment.",
    },
    created: "Vehicle created successfully.",
    updated: "Vehicle updated successfully.",
    deleted: "Vehicle deleted successfully.",
    shipmentLoaded: "Shipment assigned to vehicle.",
    shipmentUnloaded: "Shipment removed from vehicle.",
  },
} as const;
